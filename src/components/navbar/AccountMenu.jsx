        ...
        <div className="font-sans mx-auto">
            ...
            >
                <button className=" px-3 py-2 duration-200 flex items-center gap-2 font-medium text-base">
                    {
                        user?.profileImage ?  <img src={user?.profileImage} alt={"Profile Image"}  className={`w-7 aspect-square rounded-full border border-darkBgSec/50`} /> : <MdAccountCircle className={`text-2xl text-blue-600 dark:text-darkTer `}/>
                    }
                    {" "}
                    {user?.name}{" "}
                </button>
