...
const AuthComponentWrapper = ({children}) => {
    return (<section
            ...
            <div
                className={`fixed top-0 left-0 w-full px-10 md:px-16 xl:px-40 py-2 flex items-center justify-between duration-200`}>
                <CustomBtn isLink={true} href={"/"} variant={"ghost"}
            ...
            <div className={`w-full flex items-center justify-end `}>
                <Logo className={` md:max-w-sm md:max-h-96 w-full h-full max-w-[80px] max-h-20 xl:mx-0`}/>
            </div>
