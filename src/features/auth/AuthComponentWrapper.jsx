...
const AuthComponentWrapper = ({ children }) => {
    return (
        <section className=" fixed top-0 left-0 h-full flex flex-col md:flex-row md:items-center justify-center w-full z-50 gap-4 lg:gap-12 bg-white dark:bg-darkBgSec duration-200 ">
