        ...
        <section className="flex items-center justify-center w-full">
            <div className="common-card">
                <div className="text-center mb-8 space-y-3">
                    ...
                    <p className={` text-gray-500 dark:text-gray-300 text-sm`}> Enter your current password & new email
                        address which you want to change! </p>
                </div>
                ...
                <Form layout={"vertical"} onFinish={onSubmit}>
                    ...
                    <div className={`pt-6 flex items-center gap-5 `}>
                        <CustomBtn variant={"cancel"} className={`w-full`} disabled={isLoading} onClick={goBack}>
                            Cancel
                        </CustomBtn>
