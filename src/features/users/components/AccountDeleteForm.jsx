...
const AccountDeleteForm = () => {
    ...
    const onConfirmDelete = async (values) => {
        try {
            if (values.confirmation_text !== "delete my account")
    ...
    return (
        <section className="border border-red-600/50 rounded-md p-5 text-red-600 dark:text-darkRed">
            ...
            <p className={`mb-6`}>
                ...
                blogs you&apos;ve posted from our database. This can&apos;t be
                undone. So, please be certain.{" "}
            </p>
            <CustomBtn
                variant={"danger"}
                size={"sm"}
                            ...
                            <FormLabel
                                label={
                                    <>
                                        ...
                                        To verify, type{" "}
                                        <span
                                            className={`lowercase italic font-bold `}
                                        >
                                            {" "}
                                            delete my account{" "}
                                        </span>{" "}
